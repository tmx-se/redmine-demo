# 1 "C:\\Users\\shito\\AppData\\Local\\Temp\\ParaSoft.19168.25353\\ParaSoft.19168.20129.cpp"
...
CppTestTranslationUnitInfo __CPTR_tui_3022957564_19168_67134033 = 
{
    0U, 
    "C:\\Parasoft_Tutorial\\workspace_tutorial_tantai\\.cpptest\\ATM\\file-data\\TestSuite_Account_DS.cpp2e224f0c\\harness_TestSuite_Account_DS.ildb"
};

#define __CPTR_tui &__CPTR_tui_3022957564_19168_67134033
...
struct __CPTR_Initializer_3022957564_19168_67134033 {
    __CPTR_Initializer_3022957564_19168_67134033()
    {
...
static struct __CPTR_Initializer_3022957564_19168_67134033 __CPTR_initializer_3022957564_19168_67134033;
#endif

#define CPPTEST_ENTER_MAIN_ROUTINE() __CPTR_Initializer_3022957564_19168_67134033 __CPTR_main_initializer
...
EXTERN_C_LINKAGE CppTestCoverageInfo __CPTR_cui_3022957564_19168_67134033 = 
{ 
    /*prev=*/0, 
...
#define __CPTR_cui &__CPTR_cui_3022957564_19168_67134033
#define __CPTR_fid(ID) ID + __CPTR_cui_3022957564_19168_67134033.funcIdOffset
...
const char* _cpptest_strdata[] = {
    ...
    "TestSuite_Account_DS",
    "C:\\Parasoft_Tutorial\\workspace_tutorial_tantai\\ATM\\tests\\usergenerated\\TestSuite_Account_DS.cpp",
    "test_setPassword",
    "CPPTEST_DS_GET_CSTR(\"result\")",
...
{ CPPTEST_STACK_TRACE_FUNC_START_INFO() const unsigned int _CppTest_funcId = cpptestCoverageFunction(__CPTR_cui, _cpptest_strdata[7], 6);cpptestCoverageStmt(1U, -1, __CPTR_cui, _CppTest_funcId, 6);CPPTEST_STACK_TRACE_STMT_INFO(12) 
...
# 4 "C:\\Parasoft_Tutorial\\workspace_tutorial_tantai\\ATM\\tests\\usergenerated\\TestSuite_Account_DS.cpp"
class TestSuite_Account_DS : public CppTest_TestSuite { 


public: typedef TestSuite_Account_DS ThisTestSuite; static void (TestSuite_Account_DS::*call_slave_ptr)(void); static void call_slave() { CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_VARIABLE_INFO(anonymous__CPTR_1, 14) TestSuite_Account_DS s; CPPTEST_STACK_TRACE_STMT_INFO(15) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(16) s.setUp(); CPPTEST_STACK_TRACE_STMT_INFO(17) (s.*call_slave_ptr)(); CPPTEST_STACK_TRACE_STMT_INFO(18) s.tearDown(); CPPTEST_STACK_TRACE_EXIT_ROUTINE() } static void testSuiteBegin() { CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_STMT_INFO(19) cpptestTestSuiteBegin(_cpptest_strdata_var(9, "TestSuite_Account_DS"), _cpptest_strdata_var(10, "C:\\Parasoft_Tutorial\\workspace_tutorial_tantai\\ATM\\tests\\usergenerated\\TestSuite_Account_DS.cpp"), 7); CPPTEST_STACK_TRACE_EXIT_ROUTINE() } static void cpptest_test_no_exception(void (TestSuite_Account_DS::*testcase_ptr)(void)) { CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_STMT_INFO(20) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(21) try { CPPTEST_STACK_TRACE_STMT_INFO(22) try { CPPTEST_STACK_TRACE_STMT_INFO(23) call_slave_ptr = testcase_ptr; CPPTEST_STACK_TRACE_STMT_INFO(24) cpptestTestCaseSlave(&call_slave); CPPTEST_STACK_TRACE_BLOCK_END_INFO(25) } catch (std::exception &except) { CPPTEST_STACK_TRACE_EXCEPTION_HANDLER_START_INFO() CPPTEST_STACK_TRACE_STMT_INFO(26) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(27) cpptestUnhandledStdExceptionInTestCase(except.what()); CPPTEST_STACK_TRACE_BLOCK_END_INFO(28) CPPTEST_STACK_TRACE_EXIT_EXCEPTION_HANDLER() } catch (...) { CPPTEST_STACK_TRACE_EXCEPTION_HANDLER_START_INFO() CPPTEST_STACK_TRACE_STMT_INFO(29) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(30) cpptestUnhandledCppExceptionInTestCase(); CPPTEST_STACK_TRACE_BLOCK_END_INFO(31) CPPTEST_STACK_TRACE_EXIT_EXCEPTION_HANDLER() }  CPPTEST_STACK_TRACE_BLOCK_END_INFO(32) } catch (...) { CPPTEST_STACK_TRACE_EXCEPTION_HANDLER_START_INFO() CPPTEST_STACK_TRACE_BLOCK_END_INFO(33) CPPTEST_STACK_TRACE_EXIT_EXCEPTION_HANDLER() }  CPPTEST_STACK_TRACE_EXIT_ROUTINE() } static int call(const char *name) { CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_STMT_INFO(34) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(35) ; 
if (((void)CPPTEST_STACK_TRACE_IF_COND_INFO(36) , cpptestStrCmp(name, "test_setPassword") == 0)) { CPPTEST_STACK_TRACE_STMT_INFO(37) cpptestDsTestCaseBegin(_cpptest_strdata_var(11, "test_setPassword"), 0U, 0xffffU, 1, _cpptest_strdata_var(10, "C:\\Parasoft_Tutorial\\workspace_tutorial_tantai\\ATM\\tests\\usergenerated\\TestSuite_Account_DS.cpp"), 8); CPPTEST_STACK_TRACE_STMT_INFO(38) cpptestDsForCurrentTestCaseInitialized(CppTest_Ds("TestPasswordDS")); CPPTEST_STACK_TRACE_STMT_INFO(39) while ((((cpptestGetCurrentDataSource() || cpptestDsNotInitialized()), (cpptestGetCurrentDataSource()->hasMoreData || cpptestDsMethodNotInitialized("hasMoreData"))), (cpptestGetCurrentDataSource()->hasMoreData))(cpptestGetCurrentDataSource())) { if (((void)CPPTEST_STACK_TRACE_IF_COND_INFO(40) , (((cpptestGetCurrentDataSource() || cpptestDsNotInitialized()), (cpptestGetCurrentDataSource()->loadNextData || cpptestDsMethodNotInitialized("loadNextData"))), (cpptestGetCurrentDataSource()->loadNextData))(cpptestGetCurrentDataSource()))) { CPPTEST_STACK_TRACE_STMT_INFO(41) cpptestDsTestCaseIterationBegin(CPPTEST_DS_GET_ITERATION(), ((const char *)0)); CPPTEST_STACK_TRACE_STMT_INFO(42) cpptest_test_no_exception(&ThisTestSuite::test_setPassword); CPPTEST_STACK_TRACE_STMT_INFO(43) cpptestDsTestCaseIterationEnd(); CPPTEST_STACK_TRACE_BLOCK_END_INFO(44) }  CPPTEST_STACK_TRACE_BLOCK_END_INFO(45) }  CPPTEST_STACK_TRACE_STMT_INFO(46) (((cpptestGetCurrentDataSource() || cpptestDsNotInitialized()), (cpptestGetCurrentDataSource()->finalize || cpptestDsMethodNotInitialized("finalize"))), (cpptestGetCurrentDataSource()->finalize))(cpptestGetCurrentDataSource()); CPPTEST_STACK_TRACE_STMT_INFO(47) cpptestDsTestCaseEnd(); CPPTEST_STACK_TRACE_STMT_INFO(48) return 0; }  CPPTEST_STACK_TRACE_STMT_INFO(49) ; CPPTEST_STACK_TRACE_STMT_INFO(50) 
return 1; CPPTEST_STACK_TRACE_EXIT_ROUTINE() } 
...
void (TestSuite_Account_DS::*TestSuite_Account_DS::call_slave_ptr)(void); extern "C" void TestSuite_Account_DS_testSuiteBegin() { CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_STMT_INFO(51) TestSuite_Account_DS::testSuiteBegin(); CPPTEST_STACK_TRACE_EXIT_ROUTINE() } extern "C" int TestSuite_Account_DS_callTest(const char *name) { CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_STMT_INFO(52) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(53) return TestSuite_Account_DS::call(name); CPPTEST_STACK_TRACE_EXIT_ROUTINE() } 
...
CPPTEST_STACK_TRACE_VARIABLE_INFO(anonymous__CPTR_2, 54) Account _cpptest_TestObject; 

CPPTEST_STACK_TRACE_VARIABLE_INFO(anonymous__CPTR_3, 55) const char *_password = CPPTEST_DS_GET_CSTR("password"); CPPTEST_STACK_TRACE_STMT_INFO(56) 

_cpptest_TestObject.setPassword(_password); CPPTEST_STACK_TRACE_STMT_INFO(57) 

cpptestCstrEqualAssertion(((0 != cpptestCharPtrsEqual(CPPTEST_DS_GET_CSTR("result"), _cpptest_TestObject.getPassword()))), (CPPTEST_DS_GET_CSTR("result")), (_cpptest_TestObject.getPassword()), 0, 0, _cpptest_strdata_var(12, "CPPTEST_DS_GET_CSTR(\"result\")"), _cpptest_strdata_var(13, "_cpptest_TestObject.getPassword()"), _cpptest_strdata_var(10, "C:\\Parasoft_Tutorial\\workspace_tutorial_tantai\\ATM\\tests\\usergenerated\\TestSuite_Account_DS.cpp"), 40); CPPTEST_STACK_TRACE_STMT_INFO(58) ; CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
