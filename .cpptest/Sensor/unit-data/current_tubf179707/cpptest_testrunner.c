...
static void __CPTR_Initialize_Properties(void)
{
    ...
    cpptestAddProperty("testlog.file", "C:\\Parasoft_Tutorial\\workspace_tutorial_tantai\\.cpptest\\Sensor\\unit-data\\current_tubf179707/cpptest_results.tlog");
    ...
    cpptestAddProperty("covlog.file", "C:\\Parasoft_Tutorial\\workspace_tutorial_tantai\\.cpptest\\Sensor\\unit-data\\current_tubf179707/cpptest_results.clog");
...
{
    if ((cpptestStrCmp(dataSource, "__ds_step_autogen_b9a0fabd_15e079577b4") == 0) && (cpptestStrCmp(testSuite, "TestSuite_test_c_6be8bd7b") == 0)) {
#if CPPTEST_CSV_DATA_SOURCE_ENABLED
        return CPPTEST_DS_CSV("C:\\Parasoft_Tutorial\\workspace_tutorial_tantai\\.cpptest\\Sensor\\unit-data\\current_tubf179707\\ds_TestSuite_test_c_6be8bd7b___ds_step_autogen_b9a0fabd_15e079577b4.csv", ',', 1, 0);
#endif
    }
...
static void __CPTR_Do_Tests_TestSuite_test_c_6be8bd7b(void)
{
    CPPTEST_RUN_TEST_SUITE_BEGIN(TestSuite_test_c_6be8bd7b, "../../test.c", 1)
        CPPTEST_RUN_TEST_SUITE_SETUP(TestSuite_test_c_6be8bd7b)
        CPPTEST_RUN_TEST_CASE(TestSuite_test_c_6be8bd7b, TestSuite_test_c_6be8bd7b_test_case)
        CPPTEST_RUN_TEST_SUITE_TEARDOWN(TestSuite_test_c_6be8bd7b)
    CPPTEST_RUN_TEST_SUITE_END(TestSuite_test_c_6be8bd7b, 1)
}
...
static void __CPTR_Do_Tests(void)
{
    ...
    __CPTR_Do_Tests_TestSuite_test_c_6be8bd7b();
